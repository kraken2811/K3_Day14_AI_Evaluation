...
```bash
python -c "import dotenv, pytest; print('Environment OK')"
```
...
| `ModuleNotFoundError: dotenv` | Chưa activate venv hoặc chưa cài requirements | Activate `.venv`, rồi chạy `python -m pip install -r requirements.txt` |
